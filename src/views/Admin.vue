          ...
          <div class="p-6">
            <div class="flex items-center">
              ...
              <div class="flex-1 flex justify-center items-center gap-4">
                ...
                <select 
                  v-model="displayMode"
                  class="w-[30%] pl-2.5 py-2.5 rounded-lg text-center"
                  :class="[
                    isDark 
                ...
                >
                  <option value="1" class="text-center">随机模式</option>
                  <option value="2" class="text-center">标签模式</option>
                </select>
                <button 
                  @click="updateMode"
        ...
        >
          <div class="p-6">
            ...
            <div class="flex gap-4 mb-6">
              ...
              <select 
                v-model="filterType"
                class="w-40 pl-2.5 py-2.5 rounded-lg text-center"
                :class="[
                  isDark 
                    ? 'bg-slate-800/50 text-white border border-white/10 focus:border-sky-500 focus:outline-none' 
                    : 'bg-white text-slate-800 border border-slate-200 focus:border-sky-500 focus:outline-none'
              ...
              >
                <option value="all" class="text-center">全部的</option>
                <option value="active" class="text-center">已激活</option>
                <option value="inactive" class="text-center">已停用</option>
              </select>
            </div>
